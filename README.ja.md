...
| 役割 | 対応ブロック | 説明 |
|---|---|---|
| **コンテナ** | グループ, カバー | 本文表示しつつ、クリックで同内容をライトボックス表示 |
| **セルフライトボックス** | 画像（Core）, 動画, ボタン, 段落, 見出し | クリックで自身をライトボックス表示 |

### 使い方

1. **対象ブロックを配置** - グループ/カバー/動画/ボタン/段落/見出し（または画像）を追加します。
...
| 設定 | 対象 | オプション |
|---|---|---|
| ReformBox を有効化 | グループ, カバー, 動画, ボタン, 段落, 見出し | ON / OFF |
| Core 画像 Lightbox を有効化 | 画像 | ON / OFF |
| アニメーション | グループ, カバー, 動画, ボタン, 段落, 見出し | Fade, Zoom, Slide |
| オーバーレイクリックで閉じる | グループ, カバー, 動画, ボタン, 段落, 見出し | ON / OFF |
